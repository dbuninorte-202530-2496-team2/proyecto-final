...
const RegistroClasesForm: React.FC<RegistroClasesFormProps> = ({
  ...
  const isValid = useMemo(() => {
    return fecha && tutor && aula && horario && estudiantes.length > 0;
  }, [fecha, tutor, aula, horario, estudiantes]);
      ...
      <form onSubmit={onSubmit}>
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm">
                        <div className="flex justify-center">
                          <button
                            ...
                            className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold border-2 transition-all transform hover:scale-105 duration-200 ${
                              estado.asistio
                      ...
                      <td className="px-6 py-4 text-sm">
                        <select
                          ...
                          className={`w-full px-3 py-2 border-2 rounded-lg text-xs font-medium transition-all ${
                            estado.asistio
        ...
        <div className="px-6 py-4 bg-white border-t border-gray-100 flex justify-end">
          <button
            ...
            className={`inline-flex items-center gap-2 px-6 py-3 rounded-lg text-sm font-semibold transition-all transform ${
              isSaving || !isValid
